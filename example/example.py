...
if __name__ == "__main__":
    ...
    with ldev:      # либо ldev.OpenLDevice() в начале и ldev.CloseLDevice() в конце
        ...
        buffer_size = ldev.RequestBufferStream(size=131072, stream_id=L_STREAM_ADC)     # size = Pages * IrqStep
        print ("RequestBufferStream: {}".format(buffer_size))                           # size % NCh == 0 !!!
        ...
        if slPar.BoardType == E140:
            ...
            adcPar.t4.AdcIMask = e2010.SIG_0 | e2010.V30_0  # | e2010.SIG_1 | e2010.V30_1
            adcPar.t4.NCh = 1   # 2
        ...
        try:
            ...
            with open("channel-1.log", 'w') as fh:
                fh.write(str(x[0].tolist()))        # индекс соответствует номеру канала
